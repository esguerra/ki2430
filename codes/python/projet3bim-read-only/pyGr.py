...
#MENU
    def menu(self):
        ...
        Fichier.Append(wx.ID_OPEN,"&Open ","Open")
        Fichier.Append(wx.ID_CLOSE,"&Close\tCTRL+f", "Close the opened folder")
        Fichier.AppendSeparator()
        Fichier.Append(wx.ID_EXIT,"&Quit","Quit")
...
#BOITES DE DIALOGUE
    def boite(self):
        ...
        cb=wx.StaticText(self,2,"RNA Folding Simulation",(65,30),(300,90),wx.ALIGN_CENTRE)
        ...
        b=wx.Button(self,-1,"Open a Sequence",pos=(3*wi/4-15,hi/3+80),size=(160,50))
        self.Bind(wx.EVT_BUTTON,self.OnOpen,b)

        b=wx.Button(self,-1,"Quit",pos=(3*wi/4-15,hi/3+130),size=(160,50))
